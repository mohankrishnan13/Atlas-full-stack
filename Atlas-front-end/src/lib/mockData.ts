...
export const mockUsersData = [
  { id: 1, name: 'Sarah Smith', email: 'sarah@atlas.local', role: 'Admin', is_active: true, invite_pending: false },
  { id: 2, name: 'John Doe', email: 'john@atlas.local', role: 'Analyst', is_active: true, invite_pending: false },
  { id: 3, name: 'Dev Ops', email: 'dev@atlas.local', role: 'Read-Only', is_active: false, invite_pending: true },
  { id: 4, name: 'Emily Carter', email: 'emily@atlas.local', role: 'Analyst', is_active: true, invite_pending: false },
...
export const mockReportsData = {
  scheduledReports: [
    ...
    { id: 2, title: "API Consumption & Cost Analysis", description: "Detailed report on API usage, requests, and cost breakdown", schedule: "Monthly (1st day)", active: true, configureLabel: "Configure" },
    { id: 3, title: "Endpoint Security Compliance", description: "Endpoint compliance status including patch levels and policy violations", schedule: "Weekly (Friday 18:00)", active: true, configureLabel: "Configure" },
    { id: 4, title: "Network Anomaly Summary", description: "Summary of unusual network traffic and threat intelligence matches", schedule: "Daily (02:00)", active: false, configureLabel: "Configure" },
    { id: 5, title: "User Risk Activity Report", description: "Identifies high-risk users based on anomalous behavior", schedule: "Weekly (Wednesday)", active: false, configureLabel: "Configure" }
  ],
  recentDownloads: [
    { id: 1, fileName: "Auth-Service_Security_Audit.pdf", targetAppScope: "Auth-Service", generated: "Today", size: "2.4 MB", downloadUrl: "/mock-downloads/auth-service-audit.pdf" },
    { id: 2, fileName: "Network_Anomalies_Report.csv", targetAppScope: "Global", generated: "Yesterday", size: "1.8 MB", downloadUrl: "/mock-downloads/network-anomalies.csv" },
    { id: 3, fileName: "Endpoint_Compliance_Status.pdf", targetAppScope: "Endpoint Fleet", generated: "2 days ago", size: "3.2 MB", downloadUrl: "/mock-downloads/endpoint-compliance.pdf" },
    { id: 4, fileName: "API_Usage_Cost_Report.csv", targetAppScope: "API Gateway", generated: "3 days ago", size: "950 KB", downloadUrl: "/mock-downloads/api-usage.csv" },
    { id: 5, fileName: "User_Risk_Activity_Summary.pdf", targetAppScope: "Identity Platform", generated: "Last week", size: "1.5 MB", downloadUrl: "/mock-downloads/user-risk.pdf" }
  ]
};
